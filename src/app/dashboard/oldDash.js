          ...
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Total Messages</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Average Friends</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Average Daily Messages</h6>
              </div>
            </div>
          </div>
        </div>
